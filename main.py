...
# Importando Tkcalendar: pip install tkcalendar
...
app_ = Label(frameCima, text="Formulário de Consultoria",
             anchor=NW, font=('Ivy 13 bold'), bg=co2, fg=co1)
...
def atualizar():
    try:
        ...
        def update():
            ...
            lista_atualizar = [nome, email, telefone,
                               dia, estado, assunto, valor]
            ...
            if e_nome.get() == '':
                ...
                mostrar()
        botao_confirmar = Button(frameBaixo, command=update, text="Confirmar", width=10,
                                 height=1, bg=co2, fg=co1, font=('Ivy 7 bold'), relief=RAISED, overrelief=RIDGE)
...
l_nome = Label(frameBaixo, text="Nome *", height=1, anchor=NW,
               font=('Ivy 10 bold'), bg=co1, fg=co4)
l_nome.place(x=10, y=10)
e_nome = Entry(frameBaixo, width=45, justify='left', relief="solid")
e_nome.place(x=15, y=40)

l_email = Label(frameBaixo, text="email *", height=1,
...
l_tel = Label(frameBaixo, text="telefone *", height=1,
              anchor=NW, font=('Ivy 10 bold'), bg=co1, fg=co4)
l_tel.place(x=10, y=130)
e_tel = Entry(frameBaixo, width=45, justify='left', relief="solid")
e_tel.place(x=15, y=160)

l_cal = Label(frameBaixo, text="Data da consulta *", height=1,
              anchor=NW, font=('Ivy 10 bold'), bg=co1, fg=co4)
l_cal.place(x=10, y=190)
cal = DateEntry(frameBaixo, width=12, background='darkblue',
                foreground='white', borderwidth=2, year=2020)
cal.place(x=15, y=220)

l_estado = Label(frameBaixo, text="Estado da consulta *",
...
l_assunto = Label(frameBaixo, text="Consulta sobre *", height=1,
                  anchor=NW, font=('Ivy 10 bold'), bg=co1, fg=co4)
...
botao_inserir = Button(frameBaixo, command=inserir, text="Inserir", width=10,
                       height=1, bg=co6, fg=co1, font=('Ivy 7 bold'), relief=RAISED, overrelief=RIDGE)
botao_inserir.place(x=15, y=340)

botao_atualizar = Button(frameBaixo, command=atualizar, text="Atualizar", width=10,
                         height=1, bg=co2, fg=co1, font=('Ivy 7 bold'), relief=RAISED, overrelief=RIDGE)
botao_atualizar.place(x=105, y=340)

botao_deletar = Button(frameBaixo, command=deletar, text="Deletar", width=10,
                       height=1, bg=co7, fg=co1, font=('Ivy 7 bold'), relief=RAISED, overrelief=RIDGE)
